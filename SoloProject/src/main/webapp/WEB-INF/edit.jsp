...
<body>
	...
	<h1 style="text-align:center;">Edit Your Lap Time</h1>
	<hr/>
	<div style="display:flex; justify-content:center; align-items:flex-end">
		<form:form class="form" action="/edit/lap" method="post" modelAttribute="lap">
		<input type="hidden" name="_method" value="put"/>
			...
			<br/>
			<form:input type="hidden" path="id" value="${lap.id}"/>
